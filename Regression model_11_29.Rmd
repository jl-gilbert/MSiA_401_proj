...
is.factor(salestrain$recentseason)
...
salestrain$recentseason<-as.factor(salestrain$recentseason)
contrasts(salestrain$recentseason)
```
...
fit.step.sqrt.rm <- lm(sqrt(targdol) ~ slstyr + slslyr + sls2ago + sls3ago + 
    ...
    slslyr_slshist + sls2ago_slshist +  consistent1 + consistent3 + 
   consistent5 + consistent9, data = step.sqrt.rm)
