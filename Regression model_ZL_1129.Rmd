...
```{r}
names(relevantvars2)[names(relevantvars2) == 'relevantvars21'] <- 'train_21'
names(relevantvars2)[names(relevantvars2) == 'relevantvars22'] <- 'train_22'
names(relevantvars2)[names(relevantvars2) == 'relevantvars23'] <- 'train_23'
names(relevantvars2)[names(relevantvars2) == 'relevantvars24'] <- 'train_24'
names(relevantvars2)[names(relevantvars2) == 'relevantvars25'] <- 'train_25'
names(relevantvars2)[names(relevantvars2) == 'relevantvars26'] <- 'train_26'
names(relevantvars2)[names(relevantvars2) == 'relevantvars27'] <- 'train_27'
names(relevantvars2)[names(relevantvars2) == 'relevantvars28'] <- 'train_28'
names(relevantvars2)[names(relevantvars2) == 'relevantvars29'] <- 'train_29'
names(relevantvars2)[names(relevantvars2) == 'relevantvars210'] <- 'train_210'
names(relevantvars2)[names(relevantvars2) == 'relevantvars211'] <- 'train_211'
...
fit.step <- lm(log(targdol) ~ slstyr + slslyr + sls2ago + sls3ago + slshist + 
    ...
    train_22 + train_23 + train_25 + train_27 + train_29, data = relevantvars2)
summary(fit.step)
```
...
fit.step.sqrt <- lm(sqrt(targdol) ~ slstyr + slslyr + sls2ago + sls3ago + slshist + 
    ...
    train_21 + train_23 + train_25 + train_29, data = relevantvars2)
...
fit.step.rm <- lm(log(targdol) ~ slstyr + slslyr + sls2ago + sls3ago + slshist + 
    ...
    slslyr_sls2ago + slstyr_slslyr_sls2ago + slstyr_sls2ago + 
    slstyr_slshist + slslyr_slshist + sls3ago_slshist + train_21 + 
    train_22 + train_23 + train_25 + train_27 + train_29, data = step.var.rm)
summary(fit.step.rm)
...
fit.step.sqrt.rm <- lm(sqrt(targdol) ~ slstyr + slslyr + sls2ago + sls3ago + 
    slshist + ordtyr + ordlyr + ord2ago + ord3ago + recentseason + 
    years_since_purchase + slstyr_slslyr + slslyr_sls2ago + sls2ago_sls3ago + 
    slstyr_slslyr_sls2ago + slstyr_sls2ago + slstyr_slshist + 
    slslyr_slshist + sls2ago_slshist + train_21 + train_23 + 
    train_25 + train_29, data = step.sqrt.rm)
...
fit.step.nolog.rm <- lm(targdol ~ slstyr + slslyr + sls2ago + sls3ago + slshist + ordtyr + 
    ...
    slstyr_sls2ago + slstyr_sls3ago + slstyr_slshist + slslyr_slshist + 
    sls2ago_slshist + slstyr_greater_slslyr + slslyr_greater_sls2ago + 
    train_21 + train_23 + train_25 + train_29, data = step.nolog.rm)
